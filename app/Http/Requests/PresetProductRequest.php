...
class PresetProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        if($admin){
            switch ($method){
                ...
                case 'update':
                    return [
                        'delivery_company' => ['required', 'string', 'max:500'],
                        'delivery_number' => ['required', 'string', 'max:500'],
                    ];
            ...
            switch ($method) {
                ...
                case 'update':
                    return [
                        ...
                        'type_request' => ['nullable', 'string', 'max:10000'],
                        'title' => ['nullable', 'string', 'max:10000'],
                        'receiver' => ['nullable', 'string', 'max:10000'],
                        'description' => ['nullable', 'string', 'max:10000'],
                        'date' => ['nullable', 'string', 'max:10000'],
                        'sender' => ['nullable', 'string', 'max:10000'],
                        'logo_url' => ['nullable', 'string', 'max:10000'],
                        'type_stamp' => ['nullable', 'string', 'max:10000'],
                        'requirement' => ['nullable', 'string', 'max:10000'],

                        'sheet' => ['nullable', 'array', 'max:10'],
                        'logo' => ['nullable', 'array', 'max:10'],
                        'stamp' => ['nullable', 'array', 'max:10'],
                    ];
    ...
    public function bodyParameters()
    {
        return [
            'can_review' => [
                'description' => '<span class="point">리뷰가능여부 - 리뷰가능한 목록만 보고싶을 때 1로 넘기기</span>'
            ],
            'states_except' => [
                'description' => '<span class="point">목록에서 제외할 상태 목록</span>'
            ],
            'additional' => [
                'description' => '<span class="point">추가상품여부 (1이면 추가상품만, 0이면 추가상품 아닌거만)</span>'
            ],
