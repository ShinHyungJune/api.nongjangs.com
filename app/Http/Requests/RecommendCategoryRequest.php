...
class RecommendCategoryRequest extends FormRequest
{
    /**
    ...
    public function bodyParameters()
    {
        return [
            'category_id' => [
                'description' => '<span class="point">관련 카테고리 고유번호</span>',
                // 'example' => '',
            ],
            'title' => [
            ...
            'files' => [
                'description' => '<span class="point">썸네일 input-images(multiple=false) 사용</span>',
                // 'example' => '',
            ],
            'files_remove_ids' => [
